...
📖 Meilisearch's official documentation will be ready for the official v1.4.0 release. Meanwhile, work-in-progress documentation is available [here]().
...
* Dependencies upgrade
  ...
  * Upgrade Meilisearch dependencies (TBD) TBD
* CIs and tests
