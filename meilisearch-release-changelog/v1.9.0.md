...
### ⚠️ Breaking change: `_vectors.embedder` arrays can be altered by Meilisearch
...
* Speed up filter ANDs operations (#4682) @Kerollmops
* Speed up facet distribution (#4713) @Kerollmops 
...
* Fix panic in hybrid search when removing all embedders from the DB (https://github.com/meilisearch/meilisearch/pull/4715) @irevoire 
