  ...
  <details>
    <summary>Click for details</summary>
      <ul>
        ...
        <li>Incorrect use of the <code>filter</code> parameter now returns <code>invalid_search_filter</code> instead of <code>bad_request</code></li>
        <li>Incorrect use of the <code>sort</code> parameter now returns <code>invalid_search_sort</code> instead of <code>bad_request</code></li>
