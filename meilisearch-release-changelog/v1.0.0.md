...
Despite our focus on stabilizing Meilisearch, we also took the time to improve support for Japanese, Chinese and Korean!
...
Meilisearch is now better supporting Japanese and Chinese languages
...
- Improve Japanese language support:
  - Add a new Japanese normalizer that unifies hiragana and katakana equivalences
