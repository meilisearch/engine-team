...
Despite our focus on stabilizing Meilisearch, we also took the time to improve support for Japanese and Chinese!
...
You can now use the `--generate-master-key` CLI option.

It allows you to easily generate a strong master key to secure your Meilisearch instance. Using this option won't start Meilisearch and will exit without any error.
