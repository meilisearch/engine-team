...
🧰 All the integrations (SDKs, clients, libraries) will be compatible with this new Meilisearch version between 4 to 48 hours after the release. However, some new feature usages might miss in the less used integrations. Detailed information are available in each related SDK repository. You can let us know there if something is missing, or contribute directly to the repository. Every contribution is welcome! ❤️
...
* Fix the snapshots permissions on Unix system (#3561) @irevoire
