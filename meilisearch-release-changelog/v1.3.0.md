...
⚠️ While the `_rankingScore` is stable in v1.3.0 the `_rankingScoreDetails` are being released as an experimental feature. They are expected to be stabilized in v.1.4.0.
