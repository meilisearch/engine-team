...
### Other improvements
* Improve the metrics. Provides metrics on the task queue such as the number of queued tasks and the number of processing tasks. Adds the real database size used by Meilisearch. Prefixes all metrics with `_meilisearch`. (#3789) @irevoire
