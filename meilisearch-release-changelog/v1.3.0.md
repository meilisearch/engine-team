...
### Similarity score
As part of v1.3.0 Meilisearch will return a similarity score as part of the documents retrieved. This score is a dot product viewed under the `_semanticScore` property. 
