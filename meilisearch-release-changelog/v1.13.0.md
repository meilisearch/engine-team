...
From now on you can upgrade any database in v1.12 or later to the latest version without using a dump.
This means it's an in-place, faster upgrade process that consumes only the minimum amount of RAM or disk space required.

To upgrade your v1.12 database to v1.13 run:
```
