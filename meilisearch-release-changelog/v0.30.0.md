...
* Prevent filtering by the value of "inf" or "infinity" to yield an internal error (#3036 and meilisearch/milli#689) @dureuill @Kerollmops
...
- [Milli](https://github.com/meilisearch/milli): @anirudhRowjee, @ehiggs, @jeertmans, @msvaljek, @Pranav-yadav, @Samyak2, @vincent-herlemont, and @vishalsodani.
