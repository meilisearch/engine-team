...
Meilisearch v1.15.0 introduces improves the indexing performances and dumpless experience.
...
## Make it Possible to Rollback Dumpless Upgrades

TBD

Done by @dureuill in [#5523](https://github.com/meilisearch/meilisearch/pull/5523).
...
* Expose the size of the status of the task queue in the prometheus metrics by @DanasFi in [#5512](https://github.com/meilisearch/meilisearch/pull/5512)
