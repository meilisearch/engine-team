...
- Complexity of search queries has been limited to limit CPU time and RAM consumption. More specifically:
  ...
  - Queries can now contain a maximum of 1000 words. This this change only impacts queries containing very long phrases. Search terms (words not inside a phrase, and individual phrases) remain limited to 10 per query
