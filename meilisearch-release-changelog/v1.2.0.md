...
- The `exactness` ranking rule no longer treats exact matches as synonyms. This boosts  documents containing the query exactly as typed by the user. Solves https://github.com/meilisearch/meilisearch/issues/3410
