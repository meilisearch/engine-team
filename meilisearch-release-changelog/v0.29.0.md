...
In this release, we integrated a demanded feature: all query terms being present in search results. Some users have been stuck in the pre-0.21 versions because of this.
...
We integrated a [Prometheus](https://prometheus.io/) formatted metrics endpoint.
