...
⚠️ If you were doing any automation based on our log, be aware of the changes. More information [here](https://meilisearch.notion.site/Logs-trace-changes-in-v1-7-0-6dd111ecd66448aba30d2f3cef212749).
...
🗣️ This feature is experimental, and we need your help to improve it! Share your thoughts and feedback on this [GitHub discussion](TBD).
...
- `POST /logs/stderr`: Update the log level used in the console. It takes one parameter, `level`, which is the log level you want to use: `trace,` `debug,` `info,` `warn,` `error`, or `off.`
...
- When killing the listener, it may stay installed on Meilisearch for some time, and you will need to call the next route to get rid of it.
...
- [Meilisearch](https://github.com/meilisearch/meilisearch): @capJavert, @codesmith-emmy and @Gosti
