...
- [ ] Be production ready for v1
  ...
  - [ ] Ensure we don't have any bugs/crashes impacting the stability of Meilisearch. The RAM consumption should be appropriate when indexing and searching, or at least we must be transparent with the users about it.
